...
class FingerPoseEstimate:
    ...
    def calculate_orientation_of_fingers(self, image2):
        for finger in Finger:
            point_index_at = 0
            ...
            #cv2.circle(image2, (int(mid_point_at[1]), int(mid_point_at[0])), 2, (0, 255, 0), 2)
            #cv2.circle(image2, (int(end_point_at[1]), int(end_point_at[0])), 2, (0, 0, 255), 2)
    ...
    def calculate_positions_of_fingers(self, image2):
        self.calculate_slope_of_fingers()
        self.calculate_orientation_of_fingers(image2)
...
class FingerPoseEstimate2:
    ...
    def get_slope(self, point1, point2):
        value = (point1[0] - point2[0]) / (point1[1] - point2[1])
        slope = math.degrees(math.atan(value))
        if slope < 0 or slope == -0.0:
            slope = -slope
        elif slope > 0:
    ...
    def calculate_slope_of_fingers(self):
        for finger in Finger:
            ...
            for point in points:
                point1 = self.coords_xyz[point[0]]
                point2 = self.coords_xyz[point[1]]
                slope_at.append(self.get_slope(point1, point2))
            self.slopes.append(slope_at)
    ...
    def is_finger_curled(self, start_point, mid_point, end_point):
        start_mid_x_dist = start_point[1] - mid_point[1]
        start_end_x_dist = start_point[1] - end_point[1]
        mid_end_x_dist = mid_point[1] - end_point[1]
        
        start_mid_y_dist = start_point[0] - mid_point[0]
        start_end_y_dist = start_point[0] - end_point[0]
        mid_end_y_dist = mid_point[0] - end_point[0]
    ...
    def calculate_direction_of_finger(self, start_point, mid_point, end_point, finger_slopes):
        ...
        max_dist = max(start_mid_dist, start_end_dist, mid_end_dist)
        calc_start_point_x, calc_start_point_y = start_point[1], start_point[0]
        calc_end_point_x, calc_end_point_y = end_point[1], end_point[0]
        if max_dist == start_mid_dist:
            calc_end_point_x, calc_end_point_y = end_point[1], end_point[0]
        elif max_dist == mid_end_dist:
            calc_start_point_x, calc_start_point_y = mid_point[1], mid_point[0]
